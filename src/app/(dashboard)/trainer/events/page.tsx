...
export default function TrainerEventsPage() {
  ...
  const [formData, setFormData] = React.useState({
    title: "",
    description: "",
    event_type: "training_event" as EventType,
    event_date: "",
    start_time: "",
    end_time: "",
    location_name: "",
  ...
  const overlappingEvents = React.useMemo(() => {
    ...
    return events.filter((e) => {
      if (isEditMode && selectedEvent && e.id === selectedEvent.id) return false
  ...
  }, [formData.event_date, formData.start_time, formData.end_time, events, isEditMode, selectedEvent])
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      toast.success(
        isEditMode
          ? "Event aktualisiert"
          : "Event-Anfrage erstellt. Der Vorstand wird informiert."
      )
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Übersicht über alle bestätigten Events und Ihre Anfragen.
          </p>
        </div>
          ...
          {selectedEvent && (
            <>
              ...
              <ResponsiveDialogFooter className="gap-2">
                ...
                {/* Edit-Button nur für eigene Anfrage-Events */}
      ...
      >
        <ResponsiveDialogContent className="sm:max-w-lg">
          <ResponsiveDialogHeader>
            <ResponsiveDialogTitle>
              {isEditMode ? "Event bearbeiten" : "Event-Anfrage erstellen"}
            </ResponsiveDialogTitle>
            <ResponsiveDialogDescription>
              {isEditMode
                ? "Ändern Sie die Details Ihrer Event-Anfrage."
                : "Ihre Anfrage wird an den Vorstand zur Bestätigung gesendet."}
            </ResponsiveDialogDescription>
          </ResponsiveDialogHeader>
          ...
          <div className="space-y-4 py-4 max-h-[60vh] overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="z.B. Sonder-Training"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="z.B. Sportstraße 1, 12345 Musterstadt"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="z.B. Eingang Sporthalle"
              />
            </div>
          ...
          <ResponsiveDialogFooter>
            ...
            <Button onClick={handleSubmit} disabled={isSubmitting}>
              ...
              {isEditMode ? "Speichern" : "Anfrage senden"}
            </Button>
          </ResponsiveDialogFooter>
        </ResponsiveDialogContent>
      </ResponsiveDialog>
